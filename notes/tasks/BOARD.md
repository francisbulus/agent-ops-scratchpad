...
- `TKT-008` Synthetic event generator (`notes/tasks/tickets/TKT-008-synthetic-event-generator.md`)
- `TKT-009` End-to-end local stack + smoke test (`notes/tasks/tickets/TKT-009-local-stack-and-smoke-test.md`)
- `TKT-010` Structured logs + trace propagation (`notes/tasks/tickets/TKT-010-logging-and-trace-context.md`)
